...
const PERCEIVABLE: readonly WcagSuccessCriterion[] = [
  ...
  sc('1.2.1', 'Audio-only and Video-only (Prerecorded)', 'A', 'perceivable', '2.0', 'audio-only-and-video-only-prerecorded'),
  sc('1.2.2', 'Captions (Prerecorded)', 'A', 'perceivable', '2.0', 'captions-prerecorded'),
  sc('1.2.3', 'Audio Description or Media Alternative (Prerecorded)', 'A', 'perceivable', '2.0', 'audio-description-or-media-alternative-prerecorded'),
  sc('1.2.4', 'Captions (Live)', 'AA', 'perceivable', '2.0', 'captions-live'),
  sc('1.2.5', 'Audio Description (Prerecorded)', 'AA', 'perceivable', '2.0', 'audio-description-prerecorded'),
  ...
  sc('1.4.13', 'Content on Hover or Focus', 'AA', 'perceivable', '2.1', 'content-on-hover-or-focus'),
];
...
const OPERABLE: readonly WcagSuccessCriterion[] = [
  ...
  sc('2.3.1', 'Three Flashes or Below Threshold', 'A', 'operable', '2.0', 'three-flashes-or-below-threshold'),
  ...
  sc('2.4.11', 'Focus Not Obscured (Minimum)', 'AA', 'operable', '2.2', 'focus-not-obscured-minimum'),
...
const UNDERSTANDABLE: readonly WcagSuccessCriterion[] = [
  ...
  sc('3.2.4', 'Consistent Identification', 'AA', 'understandable', '2.0', 'consistent-identification'),
  ...
  sc('3.3.4', 'Error Prevention (Legal, Financial, Data)', 'AA', 'understandable', '2.0', 'error-prevention-legal-financial-data'),
  sc('3.3.7', 'Redundant Entry', 'A', 'understandable', '2.2', 'redundant-entry'),
  sc('3.3.8', 'Accessible Authentication (Minimum)', 'AA', 'understandable', '2.2', 'accessible-authentication-minimum'),
];
